...
echo -e "\033[镜像打包完成，请推送: \033[ $DOCKER_IMAGE_HOST/$DOCKER_IMAGE_NAMESPACE/$DOCKER_IMAGE_HUB:$IMAGE_TAG\n"
...
echo -e "\033[镜像推送完成: \033[ $DOCKER_IMAGE_HOST/$DOCKER_IMAGE_NAMESPACE/$DOCKER_IMAGE_HUB:$IMAGE_TAG \n"